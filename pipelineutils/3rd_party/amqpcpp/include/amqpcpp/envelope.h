...
public:
    ...
    Envelope(const std::string &body) : Envelope(body.data(), body.size()) {}
    ...
    Envelope(const MetaData &metadata, const std::string &body) : Envelope(metadata, body.data(), body.size()) {}
